...
class AIGUI(BaseGUI,
    ...
    def _build_top(self):
        ...
        model_menu = ttk.OptionMenu(top_frame, self.model_var, self.model_var.get(),
                                    #  *self._models.keys()
                                     )
    ...
    def _build_center(self):
        ...
        # radio buttons: text, image, audio (audio not implemented fully, placeholder)
        ...
        ttk.Radiobutton(mode_frame, text="Audio", variable=self.input_mode, value="Audio", command=self._on_input_mode_change).pack(side="left")
    ...
    def _browse_input(self):
        ...
        if mode == "Text":
            ...
            messagebox.showinfo("Audio", "Audio input is a placeholder in this demo.")
